...
const I18N = {
  en: {
    ...
    noticeHttp: "The connection is not protected: the password and the session cross the network in clear text. HTTPS comes in v0.7.6.",
    role_viewer: "Viewer",
    role_user: "User",
    ...
    totpHttp: "Over plain HTTP the secret crosses the network in clear text. It is safer to bind it on the server — {command} — or after the move to HTTPS (v0.7.6).",
  ...
  ru: {
    ...
    noticeHttp: "Соединение не защищено: пароль и сессия передаются открытым текстом. HTTPS — в v0.7.6.",
    ...
    totpHttp: "По HTTP секрет передаётся по сети открытым текстом. Надёжнее привязать его на сервере — {command} — или после перехода на HTTPS (v0.7.6).",
