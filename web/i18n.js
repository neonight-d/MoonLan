...
const I18N = {
  en: {
    ...
    noticeHttp: "The connection is not protected: the password and the session cross the network in clear text. HTTPS comes in v0.7.5.",
    role_viewer: "Viewer",
    role_user: "User",
    role_admin: "Administrator",
    reasonNeedRole: "needs the role “{role}”",
    reasonSignInOff: "sign-in is not set up yet",
    dragNotSaved: "Not saved: moving a pinned node needs the role “{role}”",
    usersBtn: "Users",
    moreBtn: "Actions",
    reasonScanning: "a scan is already running",
    logoutBtn: "Sign out",
    userChipHint: "Your account: password, second factor",
    signInTitle: "Sign in to MoonLan",
    signInAgain: "The session has ended. Sign in again — the map carries on where it was.",
    fieldName: "Name",
    fieldPassword: "Password",
    signInBtn: "Sign in",
    codeTitle: "Second factor",
    codeHint: "The 6-digit code from the app or the key — or one of the recovery codes.",
    fieldCode: "Code",
    confirmBtn: "Confirm",
    backBtn: "Back",
    httpSignIn: "The connection is not encrypted (HTTP): the password crosses the network in clear text.",
    err_invalid_credentials: "Wrong name or password.",
    err_locked: "The account is locked after too many failed attempts. Try again in {minutes} min, or ask an administrator to unlock it.",
    err_too_many_attempts: "Too many attempts from this computer. Wait {seconds} s.",
    err_disabled: "This account is disabled.",
    err_invalid_code: "Wrong code.",
    err_code_used: "This code has been used already — wait for the next one.",
    err_ticket_expired: "The time for the code ran out. Sign in again.",
    err_sign_in_off: "Sign-in is not set up.",
    err_sign_in_required: "Sign in first.",
    err_wrong_password: "Wrong password.",
    err_too_short: "At least 10 characters.",
    err_too_long: "Too long.",
    err_same_as_name: "The password cannot be the name.",
    err_same_as_current: "The new password is the same as the current one.",
    err_mismatch: "The two new passwords differ.",
    err_no_pending_secret: "Show the secret first.",
    err_last_admin: "This is the last enabled administrator: without one, sign-in switches off and the map is open to everyone. Make someone else an administrator first.",
    err_exists: "This name is taken.",
    err_bad_name: "A name is letters, digits, “.”, “_” and “-”, up to 32 characters, no spaces.",
    err_bad_role: "No such role.",
    err_unknown: "No such account.",
    err_other: "The server refused: {error}",
    newPasswordTitle: "Set your own password",
    newPasswordHint: "This password was temporary. Set your own to go on.",
    fieldCurrentPassword: "Current password",
    fieldNewPassword: "New password",
    fieldRepeatPassword: "The new one again",
    passwordRules: "At least 10 characters and not the name. Length is what counts, not symbols: a phrase of a few words makes a good password.",
    saveBtn: "Save",
    passwordChanged: "Password changed. Other sessions of this account closed: {n}.",
    totpTitle: "Second factor (TOTP)",
    totpRequired: "An administrator needs a second factor before anything else.",
    totpHttp: "Over plain HTTP the secret crosses the network in clear text. It is safer to bind it on the server — {command} — or after the move to HTTPS (v0.7.5).",
    totpBoundOnServer: "Bound it on the server already? Sign out and sign in again with a code.",
    showSecretBtn: "Show the secret",
    totpScanHint: "Scan the QR code with an authenticator app, or type the secret in by hand; for a hardware key, use the otpauth line.",
    totpSecretLabel: "Secret",
    totpUriLabel: "otpauth line",
    qrUnavailable: "The QR code could not be drawn (the library did not load from cdnjs). Type the secret in by hand.",
    totpConfirmHint: "Then the code it shows now, and your password.",
    bindBtn: "Bind",
    recoveryTitle: "Recovery codes",
    recoveryHint: "Each works once, in place of a code from the app — for a lost phone or key. Write them down or print them now: they are not shown again.",
    recoveryDoneBtn: "Codes saved",
    copyBtn: "Copy",
    accountTitle: "Account",
    accountRole: "Role",
    accountTotp: "Second factor",
    totpOn: "on",
    totpOff: "off",
    recoveryLeft: "recovery codes left: {n}",
    changePasswordBtn: "Change password",
    bindTotpBtn: "Turn on TOTP",
    rebindTotpBtn: "Bind TOTP again",
    rebindHint: "A new secret and new recovery codes; the old ones stop working once a code from the new secret is confirmed.",
    usersTitle: "Users",
    addBtn: "Add",
    userCreated: "{name}: temporary password {password} — hand it over once; the person sets their own at the first sign-in.",
    userNewPassword: "{name}: new temporary password {password}",
    stateActive: "active",
    stateDisabled: "disabled",
    stateLocked: "locked until {time}",
    stateMustChange: "new password at sign-in",
    userTotpOn: "TOTP on",
    userTotpOff: "no TOTP",
    userTotpAdminMissing: "no TOTP — binds it at the next sign-in",
    userLastLogin: "last sign-in {time}",
    userNever: "never signed in",
    userSessions: "sessions: {n}",
    userYou: "you",
    actNewPassword: "New password",
    actResetTotp: "Reset TOTP",
    actUnlock: "Unlock",
    actSignOut: "Sign out everywhere",
    actDisable: "Disable",
    actEnable: "Enable",
    actDelete: "Delete",
    confirmDelete: "Delete {name} for good?",
    confirmDisable: "Disable {name}? Their sessions are closed.",
    confirmResetTotp: "Remove the second factor and recovery codes of {name}?",
    confirmNewPassword: "Give {name} a new temporary password? Their sessions are closed.",
    usersDone: "Done.",
    ev_login: "Signed in",
    ev_logout: "Signed out",
    ev_account_locked: "Account locked",
    ev_user_added: "Account created",
    ev_user_role: "Role changed",
    ev_user_password: "Password changed",
    ev_user_disabled: "Account disabled",
    ev_user_enabled: "Account enabled",
    ev_user_totp_reset: "Second factor removed",
    ev_user_totp_enabled: "Second factor bound",
    ev_user_unlocked: "Account unlocked",
    ev_user_sessions_closed: "Signed out everywhere",
    ev_user_deleted: "Account deleted",
    evTemporary: "temporary password",
    evRecoveryUsed: "with a recovery code, {n} left",
    evLockedFor: "for {n} min",
  ...
  ru: {
    ...
    noticeHttp: "Соединение не защищено: пароль и сессия передаются открытым текстом. HTTPS — в v0.7.5.",
    role_viewer: "Наблюдатель",
    role_user: "Пользователь",
    role_admin: "Администратор",
    reasonNeedRole: "нужна роль «{role}»",
    reasonSignInOff: "вход ещё не настроен",
    dragNotSaved: "Не сохранено: двигать закреплённые узлы может роль «{role}»",
    usersBtn: "Пользователи",
    moreBtn: "Действия",
    reasonScanning: "опрос уже идёт",
    logoutBtn: "Выйти",
    userChipHint: "Ваша учётная запись: пароль, второй фактор",
    signInTitle: "Вход в MoonLan",
    signInAgain: "Сеанс закончился. Войдите снова — карта продолжит с того же места.",
    fieldName: "Имя",
    fieldPassword: "Пароль",
    signInBtn: "Войти",
    codeTitle: "Второй фактор",
    codeHint: "Шестизначный код из приложения или с ключа — или один из кодов восстановления.",
    fieldCode: "Код",
    confirmBtn: "Подтвердить",
    backBtn: "Назад",
    httpSignIn: "Соединение не зашифровано (HTTP): пароль передаётся по сети открытым текстом.",
    err_invalid_credentials: "Неверное имя или пароль.",
    err_locked: "Учётная запись заблокирована после неудачных попыток. Повторите через {minutes} мин или попросите администратора снять блокировку.",
    err_too_many_attempts: "Слишком много попыток с этого компьютера. Подождите {seconds} с.",
    err_disabled: "Учётная запись отключена.",
    err_invalid_code: "Неверный код.",
    err_code_used: "Этот код уже использован — дождитесь следующего.",
    err_ticket_expired: "Время на ввод кода вышло. Войдите снова.",
    err_sign_in_off: "Вход не настроен.",
    err_sign_in_required: "Сначала войдите.",
    err_wrong_password: "Неверный пароль.",
    err_too_short: "Не короче 10 символов.",
    err_too_long: "Слишком длинный.",
    err_same_as_name: "Пароль не может совпадать с именем.",
    err_same_as_current: "Новый пароль совпадает с текущим.",
    err_mismatch: "Новые пароли не совпадают.",
    err_no_pending_secret: "Сначала покажите секрет.",
    err_last_admin: "Это последний действующий администратор: без него вход выключится и карта станет открытой для всех. Сначала назначьте администратором кого-то ещё.",
    err_exists: "Это имя уже занято.",
    err_bad_name: "Имя — буквы, цифры, «.», «_» и «-», до 32 символов, без пробелов.",
    err_bad_role: "Нет такой роли.",
    err_unknown: "Нет такой учётной записи.",
    err_other: "Сервер отказал: {error}",
    newPasswordTitle: "Задайте свой пароль",
    newPasswordHint: "Этот пароль был временным. Задайте свой, чтобы продолжить.",
    fieldCurrentPassword: "Текущий пароль",
    fieldNewPassword: "Новый пароль",
    fieldRepeatPassword: "Новый ещё раз",
    passwordRules: "Не короче 10 символов и не совпадает с именем. Важна длина, а не символы: фраза из нескольких слов — хороший пароль.",
    saveBtn: "Сохранить",
    passwordChanged: "Пароль изменён. Других сеансов этой учётной записи закрыто: {n}.",
    totpTitle: "Второй фактор (TOTP)",
    totpRequired: "Администратору нужен второй фактор — до всего остального.",
    totpHttp: "По HTTP секрет передаётся по сети открытым текстом. Надёжнее привязать его на сервере — {command} — или после перехода на HTTPS (v0.7.5).",
    totpBoundOnServer: "Уже привязали на сервере? Выйдите и войдите снова с кодом.",
    showSecretBtn: "Показать секрет",
    totpScanHint: "Отсканируйте QR-код приложением-аутентификатором или введите секрет вручную; для аппаратного ключа — строка otpauth.",
    totpSecretLabel: "Секрет",
    totpUriLabel: "Строка otpauth",
    qrUnavailable: "QR-код не нарисовался (библиотека не загрузилась с cdnjs). Введите секрет вручную.",
    totpConfirmHint: "Затем — код, который оно показывает сейчас, и свой пароль.",
    bindBtn: "Привязать",
    recoveryTitle: "Коды восстановления",
    recoveryHint: "Каждый работает один раз вместо кода из приложения — на случай потерянного телефона или ключа. Запишите или распечатайте их сейчас: больше они не покажутся.",
    recoveryDoneBtn: "Коды сохранены",
    copyBtn: "Копировать",
    accountTitle: "Учётная запись",
    accountRole: "Роль",
    accountTotp: "Второй фактор",
    totpOn: "включён",
    totpOff: "выключен",
    recoveryLeft: "кодов восстановления осталось: {n}",
    changePasswordBtn: "Сменить пароль",
    bindTotpBtn: "Включить TOTP",
    rebindTotpBtn: "Перепривязать TOTP",
    rebindHint: "Новый секрет и новые коды восстановления; старые перестают работать, когда подтверждён код нового секрета.",
    usersTitle: "Пользователи",
    addBtn: "Добавить",
    userCreated: "{name}: временный пароль {password} — передайте его один раз; при первом входе человек задаст свой.",
    userNewPassword: "{name}: новый временный пароль {password}",
    stateActive: "активна",
    stateDisabled: "отключена",
    stateLocked: "заблокирована до {time}",
    stateMustChange: "новый пароль при входе",
    userTotpOn: "TOTP вкл.",
    userTotpOff: "без TOTP",
    userTotpAdminMissing: "без TOTP — привяжет при следующем входе",
    userLastLogin: "последний вход {time}",
    userNever: "входов не было",
    userSessions: "сеансов: {n}",
    userYou: "вы",
    actNewPassword: "Новый пароль",
    actResetTotp: "Сбросить TOTP",
    actUnlock: "Снять блокировку",
    actSignOut: "Завершить сеансы",
    actDisable: "Отключить",
    actEnable: "Включить",
    actDelete: "Удалить",
    confirmDelete: "Удалить {name} насовсем?",
    confirmDisable: "Отключить {name}? Сеансы будут закрыты.",
    confirmResetTotp: "Убрать у {name} второй фактор и коды восстановления?",
    confirmNewPassword: "Выдать {name} новый временный пароль? Сеансы будут закрыты.",
    usersDone: "Готово.",
    ev_login: "Вход",
    ev_logout: "Выход",
    ev_account_locked: "Учётная запись заблокирована",
    ev_user_added: "Учётная запись создана",
    ev_user_role: "Роль изменена",
    ev_user_password: "Пароль изменён",
    ev_user_disabled: "Учётная запись отключена",
    ev_user_enabled: "Учётная запись включена",
    ev_user_totp_reset: "Второй фактор сброшен",
    ev_user_totp_enabled: "Второй фактор привязан",
    ev_user_unlocked: "Блокировка снята",
    ev_user_sessions_closed: "Сеансы завершены",
    ev_user_deleted: "Учётная запись удалена",
    evTemporary: "временный пароль",
    evRecoveryUsed: "по коду восстановления, осталось {n}",
    evLockedFor: "на {n} мин",
    offlineGroup: "Офлайн",
